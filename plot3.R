...
## Turn off active graphic device and return output to screen
   ...
   with(data4, plot(Date,Sub_metering_1, type = "l", col = "black",ylab = "Energy sub metering", xlab  = ""))
   with(data4, lines(Date,Sub_metering_2, type = "l", col = "red"))
   with(data4, lines(Date,Sub_metering_3, type = "l", col = "blue"))
